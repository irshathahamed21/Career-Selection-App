...
const register = async (req, res) => {
    ...
    try {
        ...
        if (user) return res.status(400).send({message: "Please check your phone Number and password"});
...
const login = async (req, res) => {
    ...
    try {
        ...
        if(! match) return res.status(400).send({message: "Please check your phone Number and password"});
