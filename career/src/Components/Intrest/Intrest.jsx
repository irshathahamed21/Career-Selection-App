...
const update=()=>{
    myflag.current=false
    Object.keys(Intrests_career).map(function(key, index) {
        if(Intrests_career[key]==="true"){
            myflag.current=true
        }
      });

    if(myflag.current===true)  {
     receiver()}
}
   ...
   className="title_vector" src="images/Vector.png" alt="" />
    ...
    <p className="intrest_title_wlcm">Tell us about yourself!</p>
        ...
        <div className="btn_div">
            ...
            <div className="thre_div_ro"> <Btn value={"Gardening"}      label={"Gardening"}       Intrests_career={Intrests_career}     setIntrests_career={setIntrests_career}/>
            ...
            </div> <div className="thre_div_ro"> <Btn value={"Doctor"}      label={"Doctor"}         Intrests_career={Intrests_career}     setIntrests_career={setIntrests_career}/>
            ...
            </div> <div className="thre_div_ro"> <Btn value={"Photography"}      label={"Photography"}       Intrests_career={Intrests_career}     setIntrests_career={setIntrests_career}/>
